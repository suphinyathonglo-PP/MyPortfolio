...
const translations = {
  th: {
    ...
    hero: {
      ...
      description:
        "นักพัฒนา Full-Stack ที่สนใจการออกแบบระบบเว็บให้ใช้งานง่าย ดูแลต่อได้จริง และเชื่อมต่อข้อมูลอย่างเป็นระบบ มีประสบการณ์ทำงานกับ React, .NET, Node.js และฐานข้อมูลเชิงสัมพันธ์ พร้อมเรียนรู้เทคโนโลยีใหม่เพื่อสร้างงานที่ตอบโจทย์ผู้ใช้งาน",
      resume: "Resume",
